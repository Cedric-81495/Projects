...
// Async thunk to update a single product by ID
...
const productsSlice = createSlice({
    ...
    initialState: {
        products: [],
        selectedProduct: null, // Show the details of the single Product
        similarProducts: [],
        loading: false,
        error: null,
        filters: {
    ...
    reducers: {
        setFilters: (state, action) =>{
              // Merge new filters with current one
              state.filters = { ...state.filers, ...action.payload };
        },
        clearFilters: (state) => {
            state.filters = {
                collection: "",
