...
import homepage7 from "../../assets/register2.webp";
    ...
    <section className="py-16 px-4 lg:px-12">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
        ...
        <div className="lg:w-1/2">
            <img 
              src={homepage7}
              className="w-full h-full object-cover md:w-full md:h-[700px]  lg:w-full lg:h-[800px] lg:rounded-tr-3xl lg:rounded-br-3xl"
            />
        </div>
      </div>
    </section>
