  ...
  return (
    <div className="p-4">
      <h3 className="text-xl font-medium text-gray-800 mb-4">Filter</h3>
          ...
          {genders.map((gender) => (
            <div key={gender} className="flex items-center mb-1">
                <input
                  ...
                  className="mr-2 h-4 w-4 text-blue-5-- focus:ring-blue-400 border-gray-300"
                />
          ...
          <div className="flex flex-wrap gap-2">
            {colors.map((color) => (
              <button
                  ...
                  className={`w-8 h-8 rounded-full border border-gray-300 coursor-pointer transition
        ...
        {/* Size Filter */}
        <div className="mb-6">
          <label className="block text-gray-600 font-mediun mb-2">Sizes</label>
            {sizes.map((size) => (
        ...
        {/* Price Range Filter */}
          <div className="mb-8">
              <label className="text-gray-700 mb-2 font-medium block">Price Range</label>
                <input 
