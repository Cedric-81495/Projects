...
return (
  ...
  <section className="min-h-screen flex flex-col items-center justify-start px-4 bg-white text-black pt-[20px]  md:pt-[20px] relative">
      <div className="w-full max-w-5xl mx-auto">
            <div className="bg-white border border-black text-black shadow-md hover:shadow-xl transition duration-300 border-2xl p-6 sm:p-10 flex flex-col md:flex-row gap-8">
            {character.image ? (
              <img
                src={character.image}
                alt={character.name}
            ...
            <div className="grid grid-cols-1  md:grid-cols-2 gap-x-5 gap-y-4 text-base md:text-lg font-normal justify-item-center md:leading-relaxed">
        ...
        <div className="grid grid-cols-2  mb-6 md:grid-cols-3 gap-4 mt-[20px] w-full max-w-xl mx-auto px-4 font-sans">
