      ...
      <PageWrapper>
        <section className="min-h-screen flex flex-col items-center justify-start px-4 bg-white text-black pt-[20px]  md:pt-[20px] relative">
           <div className="w-full max-w-5xl mx-auto">
            <div className="bg-white border border-black text-black shadow-md hover:shadow-xl transition duration-300 border-2xl flex flex-col gap-8 md:flex-row p-6 sm:p-10">
              {student.image ? (
              ...
              <div className="flex-1 flex flex-col px-5 justify-center gap-1 md:gap-10">
                 ...
                 <div className="grid grid-cols-1  md:grid-cols-2 gap-x-5 gap-y-4 text-base md:text-lg 
