...
import requests
from format_utils import format_book_data, format_chapter_data  # Keep the formatting utilities
...
def upsert_books(books):
    ...
    for book in books:
        ...
        db_entry = {
            "id": book_id,
            "raw": book,  # Store the raw data untouched
            "ui": format_book_data(book)  # Format data for UI
        }
...
def upsert_chapters(book_id, chapters):
    ...
    for ch in chapters:
        ...
        db_entry = {
            "id": ch_id,
            "book_id": book_id,
            "raw": ch,  # Store the raw data untouched
            "ui": format_chapter_data(ch)  # Format data for UI
        }
