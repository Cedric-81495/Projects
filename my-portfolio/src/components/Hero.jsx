...
export default function Hero() {
  return (
    <section id="hero"className="min-h-screen flex items-center justify-center text-center px-6 bg-gray-200 dark:bg-gray-950 text-gray-900 dark:text-white transition-colors duration-500">
